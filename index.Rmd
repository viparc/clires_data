...
* **amoxicillin_use, ..., unknown_use:** presence (`TRUE`) / absence (`FALSE`) of `r nb_ab` antimicrobials in the flock;
* **amoxicillin_g, ..., unknown_g:** mass, in g, of the `r nb_ab` antimicriobial used in the flock;
* **amoxicillin_g.kg, ..., unknown_g.kg:** mass, in g per kg of chicken, of the `r nb_ab` antimicriobial used in the flock;
